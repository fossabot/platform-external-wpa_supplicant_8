...
#define WFD_DEVICE_INFO_AUDIO_UNSUPPORTED_AT_PRIMARY_SINK  ((u16)(BIT(10)))
#define WFD_DEVICE_INFO_AUDIO_ONLY_SUPPORT_AT_SOURCE       ((u16)(BIT(11)))
#define WFD_DEVICE_INFO_TDLS_PERSISTENT_GROUP_INTENDED     ((u16)(BIT(12)))
#define WFD_DEVICE_INFO_TDLS_PERSISTENT_GROUP_REINVOKE     ((u16)(BIT(13)))
